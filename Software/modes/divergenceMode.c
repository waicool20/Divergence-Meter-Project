...
const uint8_t PROGMEM WORLD_LINES[32][7] = { { 0, 0, 0, 0, 0, 0, 0 }, { 0, 3, 2,
    8, 4, 0, 3 }, { 0, 3, 3, 4, 5, 8, 1 }, { 0, 3, 3, 7, 1, 8, 7 }, { 0, 3, 3,
    7, 1, 9, 9 }, { 0, 3, 3, 7, 3, 3, 7 }, { 0, 4, 0, 9, 4, 2, 0 }, { 0, 4, 0,
    9, 4, 3, 1 }, { 0, 4, 5, 6, 9, 0, 3 }, { 0, 4, 5, 6, 9, 1, 4 }, { 0, 4, 5,
    6, 9, 2, 3 }, { 0, 5, 2, 3, 2, 9, 9 }, { 0, 5, 2, 3, 3, 0, 7 }, { 0, 5, 7,
    1, 0, 1, 5 }, { 0, 5, 7, 1, 0, 2, 4 }, { 0, 5, 7, 1, 0, 4, 6 }, { 1, 0, 4,
    8, 5, 9, 6 }, { 1, 0, 4, 8, 5, 9, 9 }, { 1, 0, 4, 9, 3, 2, 6 }, { 1, 1, 3,
    0, 4, 2, 6 }, { 2, 6, 1, 5, 0, 7, 4 }, { 3, 0, 1, 9, 4, 3, 0 }, { 3, 0, 3,
    0, 4, 9, 3 }, { 3, 1, 3, 0, 2, 3, 8 }, { 3, 1, 8, 2, 8, 7, 9 }, { 3, 3, 7,
    2, 3, 2, 9 }, { 3, 3, 8, 6, 0, 1, 9 }, { 3, 4, 0, 6, 2, 8, 8 }, { 3, 4, 0,
    6, 2, 8, 8 }, { 3, 6, 0, 0, 1, 0, 4 }, { 3, 6, 6, 7, 2, 9, 3 }, { BLANK, 2,
    7, 5, 3, 4, 9 }, };
